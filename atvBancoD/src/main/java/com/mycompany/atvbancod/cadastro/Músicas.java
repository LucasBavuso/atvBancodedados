 ...
 * @author marlu
 */
public class Músicas extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Músicas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
